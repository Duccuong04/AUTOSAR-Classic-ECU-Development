...
//    }
    ...
    /*Thiết lập mức logix là 0 cho các bit trong nhóm, sau đó mới ghi vào*/
    portData &= ~(ChannelGroupPtr->mask);
    portData |= ((Level << ChannelGroupPtr->offset) & ChannelGroupPtr->mask);

    /*Ghi dữ liệu vào nhóm chân*/
